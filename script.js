...
function buttonANimation() {
    document.getElementById("animatingButton").classList.toggle("change");
}
...
function showMealList(){
    ...
    meals.then(data=>{
        ...
        data.meals.forEach((element) => {
            ...
            if (isFav) {
                html += `
            <div id="card" class="card mb-3 bg-info" style="width: 20rem;">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <div class="mb-4 lead">
                            I dont think anyone made this recipe.
                        </div>
                    </div>
                </div>
            </div>
